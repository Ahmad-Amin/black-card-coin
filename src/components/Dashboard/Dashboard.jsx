      ...
      <div className=" flex flex-col gap-6 py-10 items-center">
        ...
        <ul className=" flex flex-col gap-6">
          ...
          <li className=" flex flex-row gap-5 items-center">
            ...
            <p className=" text-gray-500 duration-150 transform hover:text-white cursor-pointer">Settings</p>
          </li>
          <li className="flex flex-row gap-5 items-center">
            <svg
              width="17"
            ...
            <p className=" text-gray-500 duration-150 transform hover:text-white cursor-pointer">Rewards</p>
          </li>
        </ul>
      </div>
      <div className=" col-span-4"><MainView /></div>
    </div>
  );
};
