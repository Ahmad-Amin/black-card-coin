              ...
              <div className="flex flex-row gap-7">
                ...
                <div className=" flex flex-col justify-around">
                  ...
                  <p className="leading-[24px] font-light text-base mt-5">
                    With only 150 million $BCCOIN in total supply, 90 million
                    tokens provide liquidity on Pancakeswap v3, while 60 million
                    are reserved for strategic development.
                  </p>
                </div>
              </div>
            </Reveal>
            <Reveal>
              <div className="flex flex-row gap-7">
                ...
                <div className=" flex flex-col justify-around">
                  ...
                  <p className="leading-[24px] font-light text-base mt-5">
                    Initial token price set at 1 USDT, promising growth and
                    stability within Pancakeswap v3 trading.
                  </p>
                </div>
              </div>
            </Reveal>
