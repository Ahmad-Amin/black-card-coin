          ...
          <div className=" flex flex-col gap-14">
            <Reveal>
              <h1 className=" font-medium text-6xl  ">
                Key Features of{" "}
                <span className=" text-customGreen">BlackCard</span>
              </h1>
            </Reveal>
            ...
            <Reveal>
              <div className="flex flex-row gap-7">
                ...
                <div className=" flex flex-col justify-around">
                  ...
                  <p className="leading-[24px] font-light text-base">
                    Stake a minimum of 1,000 $BCCOIN for 6 months and become
                    part of an exclusive circle that benefits more as the value
                    escalates.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-row gap-7">
                ...
                <div className=" flex flex-col justify-around">
                  ...
                  <p className="leading-[24px] font-light text-base ">
                    ...
                    transactions. A nominal one-time 5% commission applies to
                    crypto deposits. KYC-free for a seamless experience.
                  </p>
                </div>
              </div>
            </Reveal>
