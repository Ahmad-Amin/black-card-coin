      ...
      <div className=" flex justify-center items-center flex-col gap-4">
        ...
        <Reveal>
          <p className="leading-[24px] font-light text-base w-7/12 mx-auto text-center">
            ...
            seamlessly integrate your cryptocurrency into everyday life. With
            the privilege to participate in the ecosystem's profits through
            staking, BLACKCARD revolutionizes your digital assets experience.
            Leap beyond traditional financial limitations and embrace the future
            of spending.
          </p>
        </Reveal>
      </div>
              ...
              <div className="border-r border-b w-auto inline-block p-5 lg:p-10">
                <div className=" flex gap-5 flex-col">
                  <VisibilitySensor partialVisibility offset={{ bottom: 200 }}>
                    {({ isVisible }) => (
                      <p
                        className=" font-medium text-2xl md:text-5xl text-right"
                        style={{ height: 50 }}
                      >
                        {isVisible ? (
                          <span>
                            <CountUp end={1932234} separator="," duration={3} />
                            +
                          </span>
                        ) : (
                          <span>0</span>
                  ...
                  <p className=" font-medium text-2xl text-right">
                    Registered Members
                  </p>
                </div>
              </div>
              ...
              <div className=" border-b w-auto inline-block p-5 lg:p-10">
                <div className=" flex gap-5 flex-col">
                  <VisibilitySensor partialVisibility offset={{ bottom: 200 }}>
                    {({ isVisible }) => (
                      <p
                        className=" font-medium text-2xl md:text-5xl text-left"
                        style={{ height: 50 }}
                      >
                        {isVisible ? (
                          <span>
                  ...
                  <VisibilitySensor partialVisibility offset={{ bottom: 200 }}>
                    {({ isVisible }) => (
                      ...
                      >
                        {isVisible ? (
                          <span>
                            <CountUp end={99234} separator="," duration={3} />k
                          </span>
                        ) : (
                          <span>0k</span>
                        )}
                  ...
                  <VisibilitySensor partialVisibility offset={{ bottom: 200 }}>
                    {({ isVisible }) => (
                      ...
                      >
                        {isVisible ? (
                          <span>
                            <CountUp end={932234} separator="," duration={3} />+
                          </span>
                        ) : (
                          <span>0</span>
                        )}
